...
$image = get_theme_mod( 'image_setting_url', '' );
        ...
        <section class="page-banner-section">
            <div class="container">
                <h2>
                    <span><?php echo esc_html_e('Search: ', 'gridos') . get_search_query(); ?></span>
                </h2>
            </div>
            <?php if ( $image ){ ?>
                    ...
                    <?php } ?>
                        ...
                        <?php } else { ?>
                            ...
                            <div class="not-found-title">
                                <h1><?php esc_html_e('Not Found', 'gridos'); ?></h1>
                                <span><?php echo esc_html_e('Your search results with keyword {', 'gridos') . get_search_query(); ?> <?php esc_html_e('} is null', 'gridos'); ?></span> <br>
                                <a href="<?php echo esc_url(home_url('/')); ?>"><?php esc_html_e('Back to Home', 'gridos') ?></a>
                            </div>
